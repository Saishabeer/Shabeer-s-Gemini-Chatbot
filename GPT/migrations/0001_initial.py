    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('document_path', models.CharField(blank=True, max_length=512, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='messages', to='GPT.chatsession')),
            ],
        ),
        migrations.CreateModel(
            name='User',
            ...
            managers=[
                ('objects', GPT.models.UserManager()),
            ],
        ),
        migrations.AddField(
